        ...
        <div class="description">
            ...
            <section style="margin-top: 30px;">
                ...
                <div class="code-block" style="background: rgba(0,0,0,0.3); padding: 15px; border-radius: 8px; border: 1px solid #444; font-family: monospace; word-break: break-all; margin: 15px 0;">
                    C:\\Users\\<strong style="color: #ff4b4b; background: rgba(255,75,75,0.1); padding: 2px 4px; border-radius: 3px;">{Your_Windows_Username}</strong>\\AppData\\Roaming\\SlayTheSpire2\\steam\\76561199053362469\\profile1\\saves
                </div>
